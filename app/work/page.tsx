      ...
      <section className="w-full py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {PROJECTS_DATA.map((proj) => (
            <div
              key={proj.slug}
              className="bg-[#0e121a] border border-zinc-800/90 rounded-3xl p-5 sm:p-6 flex flex-col justify-between hover:border-amber-500/40 transition-all duration-200 shadow-xl group"
            >
              <div>
                {/* Badges */}
