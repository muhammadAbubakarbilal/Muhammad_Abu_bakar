      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {INSIGHTS_DATA.map((article) => (
            <article
              key={article.slug}
              className="bg-[#0e121a] border border-zinc-800/90 rounded-2xl p-6 sm:p-7 flex flex-col justify-between hover:border-amber-500/40 transition-all duration-200 shadow-xl group"
            >
              <div>
